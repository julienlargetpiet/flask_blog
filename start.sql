...
CREATE TABLE users (username VARCHAR(16), password VARCHAR(162), ip VARCHAR(32), allow_post BOOLEAN, allow_news BOOLEAN, allow_rm_com BOOLEAN, allow_user_ban BOOLEAN, allow_recom BOOLEAN);
